...
New-Item -ItemType Directory -Force $contentRoot | Out-Null
...
Copy-Item -LiteralPath $dllPath -Destination (Join-Path $contentRoot "RelicToast.dll")
Copy-Item -LiteralPath $manifestPath -Destination (Join-Path $contentRoot "RelicToast.json")
